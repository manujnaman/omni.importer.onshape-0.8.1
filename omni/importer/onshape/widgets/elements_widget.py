            ...
            with self._widget:
                ui.Rectangle(
                    ...
                    mouse_double_clicked_fn=(
                        partial(on_mouse_double_clicked, self) if self.element["type"] in supported_elements else None
                    ),
                    style={
                        "margin_width": 8,
                ...
                with ui.ZStack(width=100):
                    self._rect = ui.Rectangle(
                        ...
                        style={
                            "margin": 15,
                            "background_color": (
                                0x44FFFFFF if self.element["type"] in supported_elements else 0x443333FF
                            ),
                            ...
                            ":checked": {
                                "background_color": (
                                    0x88000000 if self.element["type"] in supported_elements else 0x88000033
                                )
                            },
                        },
                    )
