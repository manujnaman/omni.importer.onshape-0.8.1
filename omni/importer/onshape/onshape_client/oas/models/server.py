...
try:
    from omni.importer.onshape.onshape_client.oas.models import server_variable
except ImportError:
    server_variable = sys.modules["omni.importer.onshape.onshape_client.oas.models.server_variable"]
