...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_vector2d1812
except ImportError:
    bt_vector2d1812 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_vector2d1812"]
try:
