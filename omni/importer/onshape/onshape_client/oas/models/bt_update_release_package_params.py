...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_property_value_param
except ImportError:
    bt_property_value_param = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_property_value_param"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_release_package_item_params
except ImportError:
    bt_release_package_item_params = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_release_package_item_params"
    ]
