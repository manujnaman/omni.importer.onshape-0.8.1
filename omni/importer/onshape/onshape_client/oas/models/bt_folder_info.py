...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_folder_info_all_of
except ImportError:
    bt_folder_info_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_folder_info_all_of"]
try:
