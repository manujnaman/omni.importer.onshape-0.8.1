...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_configuration_update_call2933_all_of
except ImportError:
    bt_configuration_update_call2933_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_configuration_update_call2933_all_of"
    ]
try:
