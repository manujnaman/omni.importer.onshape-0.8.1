...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_spun_description657_all_of
except ImportError:
    bt_spun_description657_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_spun_description657_all_of"
    ]
try:
