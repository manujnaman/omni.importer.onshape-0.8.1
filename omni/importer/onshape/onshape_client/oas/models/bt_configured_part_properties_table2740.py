...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_configured_part_properties_table2740_all_of
except ImportError:
    bt_configured_part_properties_table2740_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_configured_part_properties_table2740_all_of"
    ]
try:
