...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_active_sheet_metal_filter2944_all_of
except ImportError:
    bt_active_sheet_metal_filter2944_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_active_sheet_metal_filter2944_all_of"
    ]
try:
