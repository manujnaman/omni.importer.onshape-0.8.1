...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_identifier8
except ImportError:
    btp_identifier8 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btp_identifier8"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_procedure_declaration_base266
except ImportError:
    btp_procedure_declaration_base266 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_procedure_declaration_base266"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_top_level_constant_declaration283
except ImportError:
    btp_top_level_constant_declaration283 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_top_level_constant_declaration283"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_top_level_node286_all_of
except ImportError:
    btp_top_level_node286_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_top_level_node286_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_top_level_type_declaration287
except ImportError:
    btp_top_level_type_declaration287 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_top_level_type_declaration287"
    ]
