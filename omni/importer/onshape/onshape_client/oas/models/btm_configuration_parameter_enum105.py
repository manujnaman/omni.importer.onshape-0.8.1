...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_configuration_parameter_enum105_all_of
except ImportError:
    btm_configuration_parameter_enum105_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_configuration_parameter_enum105_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_enum_option592
except ImportError:
    btm_enum_option592 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_enum_option592"]
