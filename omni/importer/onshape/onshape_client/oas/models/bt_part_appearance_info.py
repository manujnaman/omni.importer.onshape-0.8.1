...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_color_info
except ImportError:
    bt_color_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_color_info"]
