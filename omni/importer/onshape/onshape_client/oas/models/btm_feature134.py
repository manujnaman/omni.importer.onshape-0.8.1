...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_feature_invalid1031
except ImportError:
    btm_feature_invalid1031 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_feature_invalid1031"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_sketch151
except ImportError:
    btm_sketch151 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_sketch151"]
