...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_full_element_id_and_part_id643_all_of
except ImportError:
    bt_full_element_id_and_part_id643_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_full_element_id_and_part_id643_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_full_element_id_with_document1729
except ImportError:
    bt_full_element_id_with_document1729 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_full_element_id_with_document1729"
    ]
try:
