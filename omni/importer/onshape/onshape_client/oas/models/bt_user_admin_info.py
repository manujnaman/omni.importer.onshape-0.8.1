...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_billing_plan_info
except ImportError:
    bt_billing_plan_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_billing_plan_info"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_device_login_secret_info
except ImportError:
    bt_device_login_secret_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_device_login_secret_info"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_discount
except ImportError:
    bt_discount = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_discount"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_privacy_consent_info
except ImportError:
    bt_privacy_consent_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_privacy_consent_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_purchase_info
except ImportError:
    bt_purchase_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_purchase_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_session_credential_info
except ImportError:
    bt_session_credential_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_session_credential_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_trial_info
except ImportError:
    bt_trial_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_trial_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_user_admin_info_all_of
except ImportError:
    bt_user_admin_info_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_user_admin_info_all_of"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_user_info
except ImportError:
    bt_user_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_user_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_user_metrics_info
except ImportError:
    bt_user_metrics_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_user_metrics_info"]
try:
