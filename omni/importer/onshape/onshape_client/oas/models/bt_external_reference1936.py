...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_document_with_version_and_element_id
except ImportError:
    bt_document_with_version_and_element_id = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_document_with_version_and_element_id"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_document_with_version_id
except ImportError:
    bt_document_with_version_id = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_document_with_version_id"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_element_reference725
except ImportError:
    bt_element_reference725 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_element_reference725"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_external_reference1936_all_of
except ImportError:
    bt_external_reference1936_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_external_reference1936_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_full_element_id756
except ImportError:
    bt_full_element_id756 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_full_element_id756"]
try:
