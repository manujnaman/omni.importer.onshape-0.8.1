...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_document_processing_info_all_of
except ImportError:
    bt_document_processing_info_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_document_processing_info_all_of"
    ]
try:
