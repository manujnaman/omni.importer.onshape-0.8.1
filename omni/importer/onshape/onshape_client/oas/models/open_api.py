...
try:
    from omni.importer.onshape.onshape_client.oas.models import components
except ImportError:
    components = sys.modules["omni.importer.onshape.onshape_client.oas.models.components"]
try:
    from omni.importer.onshape.onshape_client.oas.models import external_documentation
except ImportError:
    external_documentation = sys.modules["omni.importer.onshape.onshape_client.oas.models.external_documentation"]
try:
    from omni.importer.onshape.onshape_client.oas.models import info
except ImportError:
    info = sys.modules["omni.importer.onshape.onshape_client.oas.models.info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import path_item
except ImportError:
    path_item = sys.modules["omni.importer.onshape.onshape_client.oas.models.path_item"]
try:
    from omni.importer.onshape.onshape_client.oas.models import security_requirement
except ImportError:
    security_requirement = sys.modules["omni.importer.onshape.onshape_client.oas.models.security_requirement"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import tag
except ImportError:
    tag = sys.modules["omni.importer.onshape.onshape_client.oas.models.tag"]
