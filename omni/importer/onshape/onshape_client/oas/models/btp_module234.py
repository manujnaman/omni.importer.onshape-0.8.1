...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_cache_data_path191
except ImportError:
    bt_cache_data_path191 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_cache_data_path191"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_import
except ImportError:
    bt_import = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_import"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_microversion_id366
except ImportError:
    bt_microversion_id366 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_microversion_id366"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_module234_all_of
except ImportError:
    btp_module234_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.btp_module234_all_of"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_top_level_import285
except ImportError:
    btp_top_level_import285 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btp_top_level_import285"]
try:
