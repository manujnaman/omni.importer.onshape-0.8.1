...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_revision_approver_info
except ImportError:
    bt_revision_approver_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_revision_approver_info"]
try:
