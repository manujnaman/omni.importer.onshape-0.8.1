...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table1825
except ImportError:
    bt_table1825 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_table1825"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_base_cross_highlight_data2609
except ImportError:
    bt_table_base_cross_highlight_data2609 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_table_base_cross_highlight_data2609"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btfs_table953_all_of
except ImportError:
    btfs_table953_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.btfs_table953_all_of"]
