...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_base_sm_joint_table_row_metadata2232_all_of
except ImportError:
    bt_base_sm_joint_table_row_metadata2232_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_base_sm_joint_table_row_metadata2232_all_of"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_cross_highlight_data1753
except ImportError:
    bt_table_cross_highlight_data1753 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_table_cross_highlight_data1753"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btsm_bend_table_row_metadata1705
except ImportError:
    btsm_bend_table_row_metadata1705 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btsm_bend_table_row_metadata1705"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btsm_other_joint_table_row_metadata2640
except ImportError:
    btsm_other_joint_table_row_metadata2640 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btsm_other_joint_table_row_metadata2640"
    ]
