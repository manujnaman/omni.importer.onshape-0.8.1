...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_external_element_reference_info
except ImportError:
    bt_external_element_reference_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_external_element_reference_info"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_part_material_property_info
except ImportError:
    bt_part_material_property_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_part_material_property_info"
    ]
