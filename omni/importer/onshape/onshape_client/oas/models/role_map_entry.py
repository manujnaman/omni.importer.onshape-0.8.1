...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_identity_info
except ImportError:
    bt_identity_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_identity_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_rbac_role_info
except ImportError:
    bt_rbac_role_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_rbac_role_info"]
