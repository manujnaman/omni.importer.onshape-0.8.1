...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_name261_all_of
except ImportError:
    btp_name261_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.btp_name261_all_of"]
try:
