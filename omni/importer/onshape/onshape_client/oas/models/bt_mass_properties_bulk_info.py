...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_mass_properties_info_null
except ImportError:
    bt_mass_properties_info_null = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_mass_properties_info_null"
    ]
