...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_bill_of_materials_table1073
except ImportError:
    bt_bill_of_materials_table1073 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_bill_of_materials_table1073"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_configured_part_properties_table2740
except ImportError:
    bt_configured_part_properties_table2740 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_configured_part_properties_table2740"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btfs_table953
except ImportError:
    btfs_table953 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btfs_table953"]
