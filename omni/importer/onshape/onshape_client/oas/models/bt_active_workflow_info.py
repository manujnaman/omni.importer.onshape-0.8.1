...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_published_workflow_info
except ImportError:
    bt_published_workflow_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_published_workflow_info"]
