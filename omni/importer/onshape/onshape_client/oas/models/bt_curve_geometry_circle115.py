...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_curve_geometry_circle115_all_of
except ImportError:
    bt_curve_geometry_circle115_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_curve_geometry_circle115_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_curve_geometry_ellipse1189
except ImportError:
    bt_curve_geometry_ellipse1189 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_curve_geometry_ellipse1189"
    ]
