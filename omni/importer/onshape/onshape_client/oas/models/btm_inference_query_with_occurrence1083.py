...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_inference_query_with_occurrence1083_all_of
except ImportError:
    btm_inference_query_with_occurrence1083_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_inference_query_with_occurrence1083_all_of"
    ]
