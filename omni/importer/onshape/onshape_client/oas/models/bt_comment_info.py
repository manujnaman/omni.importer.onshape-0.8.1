...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_comment_attachment_info
except ImportError:
    bt_comment_attachment_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_comment_attachment_info"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_view_data_info
except ImportError:
    bt_view_data_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_view_data_info"]
