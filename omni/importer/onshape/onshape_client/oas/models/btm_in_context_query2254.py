...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_in_context_query2254_all_of
except ImportError:
    btm_in_context_query2254_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_in_context_query2254_all_of"
    ]
try:
