...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_key_mouse_values_info
except ImportError:
    bt_key_mouse_values_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_key_mouse_values_info"]
