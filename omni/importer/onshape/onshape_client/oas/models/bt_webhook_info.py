...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_webhook_options
except ImportError:
    bt_webhook_options = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_webhook_options"]
