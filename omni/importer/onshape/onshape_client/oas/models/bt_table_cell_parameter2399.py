...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_cell_parameter2399_all_of
except ImportError:
    bt_table_cell_parameter2399_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_table_cell_parameter2399_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_cell_property_parameter2983
except ImportError:
    bt_table_cell_property_parameter2983 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_table_cell_property_parameter2983"
    ]
try:
