...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_vector3d389
except ImportError:
    bt_vector3d389 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_vector3d389"]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_assembly_feature887
except ImportError:
    btm_assembly_feature887 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_assembly_feature887"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_mate64_all_of
except ImportError:
    btm_mate64_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_mate64_all_of"]
try:
