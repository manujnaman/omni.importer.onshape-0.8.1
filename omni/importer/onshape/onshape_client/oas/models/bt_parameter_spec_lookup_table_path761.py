...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_parameter_lookup_table_list_entry1916
except ImportError:
    bt_parameter_lookup_table_list_entry1916 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_parameter_lookup_table_list_entry1916"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_parameter_spec_lookup_table_path761_all_of
except ImportError:
    bt_parameter_spec_lookup_table_path761_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_parameter_spec_lookup_table_path761_all_of"
    ]
try:
