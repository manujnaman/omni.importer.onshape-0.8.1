...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_configured_parameter_column_info2900_all_of
except ImportError:
    bt_configured_parameter_column_info2900_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_configured_parameter_column_info2900_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_configured_values_column_info1025
except ImportError:
    bt_configured_values_column_info1025 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_configured_values_column_info1025"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_inner_parameter_location1715
except ImportError:
    bt_inner_parameter_location1715 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_inner_parameter_location1715"
    ]
try:
