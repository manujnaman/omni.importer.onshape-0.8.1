...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_parameter_derived864_all_of
except ImportError:
    btm_parameter_derived864_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_parameter_derived864_all_of"
    ]
try:
