...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_global_tree_magic_node_info_all_of
except ImportError:
    bt_global_tree_magic_node_info_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_global_tree_magic_node_info_all_of"
    ]
try:
