...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_expression_function1325_all_of
except ImportError:
    btp_expression_function1325_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_expression_function1325_all_of"
    ]
try:
