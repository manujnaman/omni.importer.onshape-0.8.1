...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_string_format_match_pattern2446_all_of
except ImportError:
    bt_string_format_match_pattern2446_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_string_format_match_pattern2446_all_of"
    ]
