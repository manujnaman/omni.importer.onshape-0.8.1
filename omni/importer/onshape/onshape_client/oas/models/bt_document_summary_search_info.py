...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_document_search_hit_info
except ImportError:
    bt_document_search_hit_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_document_search_hit_info"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_document_summary_search_info_all_of
except ImportError:
    bt_document_summary_search_info_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_document_summary_search_info_all_of"
    ]
try:
