...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_bill_of_materials_table_row1425_all_of
except ImportError:
    bt_bill_of_materials_table_row1425_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_bill_of_materials_table_row1425_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_bill_of_materials_unique_item_id2029
except ImportError:
    bt_bill_of_materials_unique_item_id2029 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_bill_of_materials_unique_item_id2029"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_base_row_metadata3181
except ImportError:
    bt_table_base_row_metadata3181 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_table_base_row_metadata3181"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_cell1114
except ImportError:
    bt_table_cell1114 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_table_cell1114"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_row1054
except ImportError:
    bt_table_row1054 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_table_row1054"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_tree_node20
except ImportError:
    bt_tree_node20 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_tree_node20"]
