...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_sketch151_all_of
except ImportError:
    btm_sketch151_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_sketch151_all_of"]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_sketch_constraint2
except ImportError:
    btm_sketch_constraint2 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_sketch_constraint2"]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_sketch_geom_entity5
except ImportError:
    btm_sketch_geom_entity5 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_sketch_geom_entity5"]
