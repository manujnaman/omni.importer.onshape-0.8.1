...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_workflow_action_info
except ImportError:
    bt_workflow_action_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_workflow_action_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_workflow_state_info
except ImportError:
    bt_workflow_state_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_workflow_state_info"]
