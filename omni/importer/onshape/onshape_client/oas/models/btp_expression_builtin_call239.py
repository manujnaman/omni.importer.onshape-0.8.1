...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_expression_builtin_call239_all_of
except ImportError:
    btp_expression_builtin_call239_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_expression_builtin_call239_all_of"
    ]
try:
