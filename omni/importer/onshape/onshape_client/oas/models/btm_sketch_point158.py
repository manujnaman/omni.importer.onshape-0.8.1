...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_sketch_point158_all_of
except ImportError:
    btm_sketch_point158_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_sketch_point158_all_of"]
