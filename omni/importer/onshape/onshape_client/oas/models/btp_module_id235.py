...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_module_id235_all_of
except ImportError:
    btp_module_id235_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.btp_module_id235_all_of"]
try:
