...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_mate_connector66_all_of
except ImportError:
    btm_mate_connector66_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_mate_connector66_all_of"
    ]
try:
