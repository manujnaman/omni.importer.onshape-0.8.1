...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_assembly_feature_data_info
except ImportError:
    bt_assembly_feature_data_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_assembly_feature_data_info"
    ]
