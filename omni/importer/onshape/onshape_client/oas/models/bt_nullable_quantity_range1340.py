...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_nullable_quantity_range1340_all_of
except ImportError:
    bt_nullable_quantity_range1340_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_nullable_quantity_range1340_all_of"
    ]
try:
