...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_rbac_permission_scheme_info
except ImportError:
    bt_rbac_permission_scheme_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_rbac_permission_scheme_info"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import role_map_entry
except ImportError:
    role_map_entry = sys.modules["omni.importer.onshape.onshape_client.oas.models.role_map_entry"]
