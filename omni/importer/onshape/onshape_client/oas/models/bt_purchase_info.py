...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_card_info
except ImportError:
    bt_card_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_card_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_plan_subscriber_info
except ImportError:
    bt_plan_subscriber_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_plan_subscriber_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import btapi_application_summary_info
except ImportError:
    btapi_application_summary_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btapi_application_summary_info"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import next_charge
except ImportError:
    next_charge = sys.modules["omni.importer.onshape.onshape_client.oas.models.next_charge"]
try:
    from omni.importer.onshape.onshape_client.oas.models import prorated_charges
except ImportError:
    prorated_charges = sys.modules["omni.importer.onshape.onshape_client.oas.models.prorated_charges"]
try:
