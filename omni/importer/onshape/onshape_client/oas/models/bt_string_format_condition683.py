...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_string_format_block_pattern1755
except ImportError:
    bt_string_format_block_pattern1755 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_string_format_block_pattern1755"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_string_format_match_pattern2446
except ImportError:
    bt_string_format_match_pattern2446 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_string_format_match_pattern2446"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_string_maximum_length_pattern2593
except ImportError:
    bt_string_maximum_length_pattern2593 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_string_maximum_length_pattern2593"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_string_minimum_length_pattern895
except ImportError:
    bt_string_minimum_length_pattern895 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_string_minimum_length_pattern895"
    ]
