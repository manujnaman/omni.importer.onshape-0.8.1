...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_individual_co_edge_query1332_all_of
except ImportError:
    btm_individual_co_edge_query1332_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_individual_co_edge_query1332_all_of"
    ]
try:
