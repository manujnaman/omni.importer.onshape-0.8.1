...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_export_model_arc_edge_geometry1257_all_of
except ImportError:
    bt_export_model_arc_edge_geometry1257_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_export_model_arc_edge_geometry1257_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_export_model_edge_geometry1125
except ImportError:
    bt_export_model_edge_geometry1125 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_export_model_edge_geometry1125"
    ]
try:
