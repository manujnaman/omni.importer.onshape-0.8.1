...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_user_summary_info_all_of
except ImportError:
    bt_user_summary_info_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_user_summary_info_all_of"
    ]
try:
