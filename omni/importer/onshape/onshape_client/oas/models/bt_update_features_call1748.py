...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_update_features_call1748_all_of
except ImportError:
    bt_update_features_call1748_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_update_features_call1748_all_of"
    ]
try:
