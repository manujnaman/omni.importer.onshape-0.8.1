...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_diff_info
except ImportError:
    bt_diff_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_diff_info"]
