...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_cone_description860_all_of
except ImportError:
    bt_cone_description860_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_cone_description860_all_of"
    ]
try:
