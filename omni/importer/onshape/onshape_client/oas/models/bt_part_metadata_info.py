...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_custom_property_definition_info
except ImportError:
    bt_custom_property_definition_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_custom_property_definition_info"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_part_appearance_info
except ImportError:
    bt_part_appearance_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_part_appearance_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_part_material_info
except ImportError:
    bt_part_material_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_part_material_info"]
try:
