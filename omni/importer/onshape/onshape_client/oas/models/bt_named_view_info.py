...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_section_plane_info
except ImportError:
    bt_section_plane_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_section_plane_info"]
