...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_conversion_function1362_all_of
except ImportError:
    btp_conversion_function1362_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_conversion_function1362_all_of"
    ]
try:
