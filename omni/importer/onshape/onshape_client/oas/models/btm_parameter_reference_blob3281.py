...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_parameter_reference_cad_import2016
except ImportError:
    btm_parameter_reference_cad_import2016 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_parameter_reference_cad_import2016"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_parameter_reference_image2014
except ImportError:
    btm_parameter_reference_image2014 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_parameter_reference_image2014"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_parameter_reference_json790
except ImportError:
    btm_parameter_reference_json790 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_parameter_reference_json790"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_parameter_reference_table917
except ImportError:
    btm_parameter_reference_table917 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_parameter_reference_table917"
    ]
