...
try:
    from omni.importer.onshape.onshape_client.oas.models import btsm_definition_entity_type_filter1651_all_of
except ImportError:
    btsm_definition_entity_type_filter1651_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btsm_definition_entity_type_filter1651_all_of"
    ]
