...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_operator_declaration264_all_of
except ImportError:
    btp_operator_declaration264_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_operator_declaration264_all_of"
    ]
try:
