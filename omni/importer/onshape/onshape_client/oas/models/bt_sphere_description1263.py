...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_sphere_description1263_all_of
except ImportError:
    bt_sphere_description1263_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_sphere_description1263_all_of"
    ]
try:
