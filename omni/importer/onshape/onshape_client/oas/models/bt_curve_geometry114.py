...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_curve_geometry_circle115
except ImportError:
    bt_curve_geometry_circle115 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_curve_geometry_circle115"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_curve_geometry_conic2284
except ImportError:
    bt_curve_geometry_conic2284 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_curve_geometry_conic2284"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_curve_geometry_interpolated_spline116
except ImportError:
    bt_curve_geometry_interpolated_spline116 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_curve_geometry_interpolated_spline116"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_curve_geometry_line117
except ImportError:
    bt_curve_geometry_line117 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_curve_geometry_line117"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_curve_geometry_spline118
except ImportError:
    bt_curve_geometry_spline118 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_curve_geometry_spline118"
    ]
