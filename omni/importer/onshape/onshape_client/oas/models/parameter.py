...
try:
    from omni.importer.onshape.onshape_client.oas.models import media_type
except ImportError:
    media_type = sys.modules["omni.importer.onshape.onshape_client.oas.models.media_type"]
try:
