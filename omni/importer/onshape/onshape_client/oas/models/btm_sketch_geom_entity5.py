...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_sketch_image_entity763
except ImportError:
    btm_sketch_image_entity763 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_sketch_image_entity763"]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_sketch_point158
except ImportError:
    btm_sketch_point158 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_sketch_point158"]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_sketch_text_entity1761
except ImportError:
    btm_sketch_text_entity1761 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_sketch_text_entity1761"]
