...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_bill_of_materials_table1073_all_of
except ImportError:
    bt_bill_of_materials_table1073_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_bill_of_materials_table1073_all_of"
    ]
try:
