...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_export_model_coedge1342
except ImportError:
    bt_export_model_coedge1342 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_export_model_coedge1342"]
