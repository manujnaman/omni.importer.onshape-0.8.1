...
try:
    from omni.importer.onshape.onshape_client.oas.models import configuration_entry
except ImportError:
    configuration_entry = sys.modules["omni.importer.onshape.onshape_client.oas.models.configuration_entry"]
