...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_custom_property_definition_params
except ImportError:
    bt_custom_property_definition_params = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_custom_property_definition_params"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_material_params
except ImportError:
    bt_material_params = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_material_params"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_part_appearance_params
except ImportError:
    bt_part_appearance_params = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_part_appearance_params"]
