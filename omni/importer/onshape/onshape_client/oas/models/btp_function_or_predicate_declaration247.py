...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_function_declaration246
except ImportError:
    btp_function_declaration246 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_function_declaration246"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_function_or_predicate_declaration247_all_of
except ImportError:
    btp_function_or_predicate_declaration247_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_function_or_predicate_declaration247_all_of"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_predicate_declaration265
except ImportError:
    btp_predicate_declaration265 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_predicate_declaration265"
    ]
try:
