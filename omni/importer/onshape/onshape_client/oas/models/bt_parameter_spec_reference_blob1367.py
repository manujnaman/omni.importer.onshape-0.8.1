...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_parameter_spec_reference_cad_import1792
except ImportError:
    bt_parameter_spec_reference_cad_import1792 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_parameter_spec_reference_cad_import1792"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_parameter_spec_reference_image1722
except ImportError:
    bt_parameter_spec_reference_image1722 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_parameter_spec_reference_image1722"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_parameter_spec_reference_json1816
except ImportError:
    bt_parameter_spec_reference_json1816 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_parameter_spec_reference_json1816"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_parameter_spec_reference_table1520
except ImportError:
    bt_parameter_spec_reference_table1520 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_parameter_spec_reference_table1520"
    ]
try:
