...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_metadata_enum_value_info
except ImportError:
    bt_metadata_enum_value_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_metadata_enum_value_info"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_metadata_property_ui_hints_info
except ImportError:
    bt_metadata_property_ui_hints_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_metadata_property_ui_hints_info"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_metadata_property_validator_info
except ImportError:
    bt_metadata_property_validator_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_metadata_property_validator_info"
    ]
