...
try:
    from omni.importer.onshape.onshape_client.oas.models import btfs_value1888
except ImportError:
    btfs_value1888 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btfs_value1888"]
