...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_comment_info
except ImportError:
    bt_comment_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_comment_info"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_release_comment_list_info
except ImportError:
    bt_release_comment_list_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_release_comment_list_info"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_release_package_item_info
except ImportError:
    bt_release_package_item_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_release_package_item_info"
    ]
try:
