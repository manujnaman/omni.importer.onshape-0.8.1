...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_identifier8_all_of
except ImportError:
    btp_identifier8_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.btp_identifier8_all_of"]
try:
