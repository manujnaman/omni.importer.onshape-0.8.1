...
from omni.importer.onshape.onshape_client.oas.model_utils import ModelNormal, date, datetime, int, str  # noqa: F401

try:
    from omni.importer.onshape.onshape_client.oas.models import body_part
except ImportError:
    body_part = sys.modules["omni.importer.onshape.onshape_client.oas.models.body_part"]
try:
    from omni.importer.onshape.onshape_client.oas.models import body_part_media_type
except ImportError:
    body_part_media_type = sys.modules["omni.importer.onshape.onshape_client.oas.models.body_part_media_type"]
try:
    from omni.importer.onshape.onshape_client.oas.models import content_disposition
except ImportError:
    content_disposition = sys.modules["omni.importer.onshape.onshape_client.oas.models.content_disposition"]
try:
    from omni.importer.onshape.onshape_client.oas.models import form_data_body_part
except ImportError:
    form_data_body_part = sys.modules["omni.importer.onshape.onshape_client.oas.models.form_data_body_part"]
try:
    from omni.importer.onshape.onshape_client.oas.models import multi_part
except ImportError:
    multi_part = sys.modules["omni.importer.onshape.onshape_client.oas.models.multi_part"]
try:
    from omni.importer.onshape.onshape_client.oas.models import parameterized_header
except ImportError:
    parameterized_header = sys.modules["omni.importer.onshape.onshape_client.oas.models.parameterized_header"]
