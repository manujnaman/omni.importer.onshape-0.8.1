...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_share_entry_params
except ImportError:
    bt_share_entry_params = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_share_entry_params"]
