...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_associative_data_info
except ImportError:
    bt_associative_data_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_associative_data_info"]
