...
try:
    ...
    bt_feature_api_base1430 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_feature_api_base1430"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_feature_list_response2457_all_of
except ImportError:
    bt_feature_list_response2457_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_feature_list_response2457_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_feature_state1688
except ImportError:
    bt_feature_state1688 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_feature_state1688"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_import136
except ImportError:
    btm_import136 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_import136"]
