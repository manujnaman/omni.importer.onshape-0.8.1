...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_parameter_visibility_on_equal180_all_of
except ImportError:
    bt_parameter_visibility_on_equal180_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_parameter_visibility_on_equal180_all_of"
    ]
try:
