...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_external_reference1936
except ImportError:
    bt_external_reference1936 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_external_reference1936"]
try:
