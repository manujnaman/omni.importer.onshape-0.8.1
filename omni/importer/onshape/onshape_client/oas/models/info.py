...
try:
    from omni.importer.onshape.onshape_client.oas.models import contact
except ImportError:
    contact = sys.modules["omni.importer.onshape.onshape_client.oas.models.contact"]
try:
    from omni.importer.onshape.onshape_client.oas.models import license
except ImportError:
    license = sys.modules["omni.importer.onshape.onshape_client.oas.models.license"]
