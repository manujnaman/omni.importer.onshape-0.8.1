...
try:
    from omni.importer.onshape.onshape_client.oas.models import discriminator
except ImportError:
    discriminator = sys.modules["omni.importer.onshape.onshape_client.oas.models.discriminator"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import xml
except ImportError:
    xml = sys.modules["omni.importer.onshape.onshape_client.oas.models.xml"]
