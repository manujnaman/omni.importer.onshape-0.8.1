...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_argument_declaration232_all_of
except ImportError:
    btp_argument_declaration232_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_argument_declaration232_all_of"
    ]
try:
