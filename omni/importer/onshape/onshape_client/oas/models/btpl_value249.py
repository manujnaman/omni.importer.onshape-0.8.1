...
try:
    from omni.importer.onshape.onshape_client.oas.models import btpl_value_access250
except ImportError:
    btpl_value_access250 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btpl_value_access250"]
try:
    from omni.importer.onshape.onshape_client.oas.models import btpl_value_box_dereference251
except ImportError:
    btpl_value_box_dereference251 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btpl_value_box_dereference251"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btpl_value_var_reference252
except ImportError:
    btpl_value_var_reference252 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btpl_value_var_reference252"
    ]
