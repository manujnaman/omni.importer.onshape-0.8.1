...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_feature_definition_call1406_all_of
except ImportError:
    bt_feature_definition_call1406_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_feature_definition_call1406_all_of"
    ]
try:
