...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_parameter_nullable_quantity807
except ImportError:
    btm_parameter_nullable_quantity807 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_parameter_nullable_quantity807"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_parameter_quantity147_all_of
except ImportError:
    btm_parameter_quantity147_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_parameter_quantity147_all_of"
    ]
