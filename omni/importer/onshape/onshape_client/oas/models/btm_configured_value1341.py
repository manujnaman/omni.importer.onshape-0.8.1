...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_configured_value_by_boolean1501
except ImportError:
    btm_configured_value_by_boolean1501 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_configured_value_by_boolean1501"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_configured_value_by_enum1923
except ImportError:
    btm_configured_value_by_enum1923 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_configured_value_by_enum1923"
    ]
try:
