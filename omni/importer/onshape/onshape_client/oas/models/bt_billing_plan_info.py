...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_discount_info
except ImportError:
    bt_discount_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_discount_info"]
