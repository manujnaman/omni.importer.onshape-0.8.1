...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_spline_description2118_all_of
except ImportError:
    bt_spline_description2118_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_spline_description2118_all_of"
    ]
