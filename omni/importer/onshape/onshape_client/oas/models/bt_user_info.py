...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_user_admin_info
except ImportError:
    bt_user_admin_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_user_admin_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_user_info_all_of
except ImportError:
    bt_user_info_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_user_info_all_of"]
try:
