...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_cell_parameter2399
except ImportError:
    bt_table_cell_parameter2399 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_table_cell_parameter2399"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_cell_property_parameter2983_all_of
except ImportError:
    bt_table_cell_property_parameter2983_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_table_cell_property_parameter2983_all_of"
    ]
try:
