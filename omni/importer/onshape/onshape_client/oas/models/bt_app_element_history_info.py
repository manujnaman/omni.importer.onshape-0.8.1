...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_app_element_history_entry_info
except ImportError:
    bt_app_element_history_entry_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_app_element_history_entry_info"
    ]
