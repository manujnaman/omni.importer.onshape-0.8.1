...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_explosion2754_all_of
except ImportError:
    bt_explosion2754_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_explosion2754_all_of"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_microversion_id_and_configuration2338
except ImportError:
    bt_microversion_id_and_configuration2338 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_microversion_id_and_configuration2338"
    ]
try:
