...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_individual_query_with_occurrence811_all_of
except ImportError:
    btm_individual_query_with_occurrence811_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_individual_query_with_occurrence811_all_of"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_inference_query_with_occurrence1083
except ImportError:
    btm_inference_query_with_occurrence1083 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_inference_query_with_occurrence1083"
    ]
