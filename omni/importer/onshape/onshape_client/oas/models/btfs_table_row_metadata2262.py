...
try:
    from omni.importer.onshape.onshape_client.oas.models import btfs_table_row_metadata2262_all_of
except ImportError:
    btfs_table_row_metadata2262_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btfs_table_row_metadata2262_all_of"
    ]
