...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_configuration_parameter_boolean2550
except ImportError:
    btm_configuration_parameter_boolean2550 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_configuration_parameter_boolean2550"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_configuration_parameter_enum105
except ImportError:
    btm_configuration_parameter_enum105 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_configuration_parameter_enum105"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_configuration_parameter_quantity1826
except ImportError:
    btm_configuration_parameter_quantity1826 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_configuration_parameter_quantity1826"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_configuration_parameter_string872
except ImportError:
    btm_configuration_parameter_string872 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_configuration_parameter_string872"
    ]
