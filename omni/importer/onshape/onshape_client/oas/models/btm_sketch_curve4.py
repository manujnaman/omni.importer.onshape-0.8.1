...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_sketch_curve4_all_of
except ImportError:
    btm_sketch_curve4_all_of = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_sketch_curve4_all_of"]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_sketch_curve_segment155
except ImportError:
    btm_sketch_curve_segment155 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_sketch_curve_segment155"
    ]
try:
