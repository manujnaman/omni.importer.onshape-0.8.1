...
try:
    ...
    bt_metadata_property_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_metadata_property_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_release_package_item_error
except ImportError:
    bt_release_package_item_error = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_release_package_item_error"
    ]
