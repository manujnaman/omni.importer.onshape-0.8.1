...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_individual_created_by_query137_all_of
except ImportError:
    btm_individual_created_by_query137_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_individual_created_by_query137_all_of"
    ]
try:
