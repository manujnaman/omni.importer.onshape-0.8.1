...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_set_feature_rollback_call1899_all_of
except ImportError:
    bt_set_feature_rollback_call1899_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_set_feature_rollback_call1899_all_of"
    ]
