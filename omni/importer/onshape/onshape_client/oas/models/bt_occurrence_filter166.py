...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_occurrence_filter166_all_of
except ImportError:
    bt_occurrence_filter166_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_occurrence_filter166_all_of"
    ]
try:
