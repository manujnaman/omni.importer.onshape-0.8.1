...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_computed_configuration_input_spec2525
except ImportError:
    bt_computed_configuration_input_spec2525 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_computed_configuration_input_spec2525"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_parameter_spec_reference_part_studio1256_all_of
except ImportError:
    bt_parameter_spec_reference_part_studio1256_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_parameter_spec_reference_part_studio1256_all_of"
    ]
try:
