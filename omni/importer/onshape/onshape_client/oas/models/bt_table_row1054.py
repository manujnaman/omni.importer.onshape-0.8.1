...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_bill_of_materials_table_row1425
except ImportError:
    bt_bill_of_materials_table_row1425 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_bill_of_materials_table_row1425"
    ]
try:
