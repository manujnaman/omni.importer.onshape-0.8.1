...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_base_info
except ImportError:
    bt_base_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_base_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_document_info
except ImportError:
    bt_document_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_document_info"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_document_summary_info_all_of
except ImportError:
    bt_document_summary_info_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_document_summary_info_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_document_summary_search_info
except ImportError:
    bt_document_summary_search_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_document_summary_search_info"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_global_tree_node_info
except ImportError:
    bt_global_tree_node_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_global_tree_node_info"]
try:
...
try:
    ...
    bt_workspace_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_workspace_info"]
