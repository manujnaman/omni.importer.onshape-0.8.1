...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_test_cell_double2509
except ImportError:
    bt_table_test_cell_double2509 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_table_test_cell_double2509"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_test_cell_string2112
except ImportError:
    bt_table_test_cell_string2112 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_table_test_cell_string2112"
    ]
