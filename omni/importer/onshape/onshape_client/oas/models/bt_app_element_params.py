...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_app_element_change_params
except ImportError:
    bt_app_element_change_params = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_app_element_change_params"
    ]
try:
