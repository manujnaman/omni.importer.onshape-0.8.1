...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_insertable_info
except ImportError:
    bt_insertable_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_insertable_info"]
