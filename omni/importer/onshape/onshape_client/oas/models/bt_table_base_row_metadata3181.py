...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_base_sm_joint_table_row_metadata2232
except ImportError:
    bt_base_sm_joint_table_row_metadata2232 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_base_sm_joint_table_row_metadata2232"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_bill_of_materials_table_row_metadata1300
except ImportError:
    bt_bill_of_materials_table_row_metadata1300 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_bill_of_materials_table_row_metadata1300"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btfs_table_row_metadata2262
except ImportError:
    btfs_table_row_metadata2262 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btfs_table_row_metadata2262"
    ]
