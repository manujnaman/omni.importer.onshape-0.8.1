...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_node_reference21
except ImportError:
    bt_node_reference21 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_node_reference21"]
