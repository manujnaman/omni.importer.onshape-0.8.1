...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_assembly_feature_info
except ImportError:
    bt_assembly_feature_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_assembly_feature_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_assembly_instance_info
except ImportError:
    bt_assembly_instance_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_assembly_instance_info"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_assembly_occurrence_info
except ImportError:
    bt_assembly_occurrence_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_assembly_occurrence_info"
    ]
