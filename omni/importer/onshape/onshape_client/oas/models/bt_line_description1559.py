...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_line_description1559_all_of
except ImportError:
    bt_line_description1559_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_line_description1559_all_of"
    ]
try:
