...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_statement_continue274_all_of
except ImportError:
    btp_statement_continue274_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_statement_continue274_all_of"
    ]
