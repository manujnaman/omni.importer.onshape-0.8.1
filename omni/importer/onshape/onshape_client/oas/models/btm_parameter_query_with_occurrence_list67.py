...
try:
    ...
    bt_occurrence74 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_occurrence74"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_parameter_query_with_occurrence_list67_all_of
except ImportError:
    btm_parameter_query_with_occurrence_list67_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_parameter_query_with_occurrence_list67_all_of"
    ]
