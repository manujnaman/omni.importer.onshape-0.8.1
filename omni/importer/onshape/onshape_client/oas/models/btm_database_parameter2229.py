...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_database_parameter2229_all_of
except ImportError:
    btm_database_parameter2229_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_database_parameter2229_all_of"
    ]
try:
