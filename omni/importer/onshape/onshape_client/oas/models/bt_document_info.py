...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_document_processing_info
except ImportError:
    bt_document_processing_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_document_processing_info"
    ]
try:
