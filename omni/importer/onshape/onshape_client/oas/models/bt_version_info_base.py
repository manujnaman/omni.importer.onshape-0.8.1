...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_version_info_base_all_of
except ImportError:
    bt_version_info_base_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_version_info_base_all_of"
    ]
try:
