...
try:
    from omni.importer.onshape.onshape_client.oas.models import btfs_value_boolean1195_all_of
except ImportError:
    btfs_value_boolean1195_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btfs_value_boolean1195_all_of"
    ]
