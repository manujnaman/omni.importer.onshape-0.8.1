...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_configured_value1341
except ImportError:
    btm_configured_value1341 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_configured_value1341"]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_configured_value_by_boolean1501_all_of
except ImportError:
    btm_configured_value_by_boolean1501_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_configured_value_by_boolean1501_all_of"
    ]
try:
