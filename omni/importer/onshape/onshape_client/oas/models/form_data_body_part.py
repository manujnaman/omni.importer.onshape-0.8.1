...
try:
    from omni.importer.onshape.onshape_client.oas.models import form_data_content_disposition
except ImportError:
    form_data_content_disposition = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.form_data_content_disposition"
    ]
try:
