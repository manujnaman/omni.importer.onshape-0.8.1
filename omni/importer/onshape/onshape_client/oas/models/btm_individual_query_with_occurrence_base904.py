...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_feature_query_with_occurrence157
except ImportError:
    btm_feature_query_with_occurrence157 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_feature_query_with_occurrence157"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_individual_occurrence_query626
except ImportError:
    btm_individual_occurrence_query626 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_individual_occurrence_query626"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_individual_query_with_occurrence811
except ImportError:
    btm_individual_query_with_occurrence811 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_individual_query_with_occurrence811"
    ]
