...
try:
    from omni.importer.onshape.onshape_client.oas.models import request_options
except ImportError:
    request_options = sys.modules["omni.importer.onshape.onshape_client.oas.models.request_options"]
try:
    from omni.importer.onshape.onshape_client.oas.models import subscription_item
except ImportError:
    subscription_item = sys.modules["omni.importer.onshape.onshape_client.oas.models.subscription_item"]
