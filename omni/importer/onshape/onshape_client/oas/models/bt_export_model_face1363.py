...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_bounding_box1052
except ImportError:
    bt_bounding_box1052 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_bounding_box1052"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_export_model_loop1182
except ImportError:
    bt_export_model_loop1182 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_export_model_loop1182"]
try:
