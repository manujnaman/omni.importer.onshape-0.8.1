...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_editing_logic2350
except ImportError:
    bt_editing_logic2350 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_editing_logic2350"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_feature_spec129
except ImportError:
    bt_feature_spec129 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_feature_spec129"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_location_info226
except ImportError:
    bt_location_info226 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_location_info226"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_parameter_group_spec3469
except ImportError:
    bt_parameter_group_spec3469 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_parameter_group_spec3469"
    ]
try:
