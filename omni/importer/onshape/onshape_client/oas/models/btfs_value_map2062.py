...
try:
    from omni.importer.onshape.onshape_client.oas.models import btfs_value_map_entry2077
except ImportError:
    btfs_value_map_entry2077 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btfs_value_map_entry2077"]
