...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_parameter_spec_string175_all_of
except ImportError:
    bt_parameter_spec_string175_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_parameter_spec_string175_all_of"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_string_format_condition683
except ImportError:
    bt_string_format_condition683 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_string_format_condition683"
    ]
try:
