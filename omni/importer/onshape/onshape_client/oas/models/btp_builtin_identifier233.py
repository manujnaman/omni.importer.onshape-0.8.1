...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_builtin_identifier233_all_of
except ImportError:
    btp_builtin_identifier233_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_builtin_identifier233_all_of"
    ]
try:
