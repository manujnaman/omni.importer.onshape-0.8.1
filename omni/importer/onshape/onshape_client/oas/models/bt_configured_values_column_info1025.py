...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_configured_dimension_column_info2168
except ImportError:
    bt_configured_dimension_column_info2168 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_configured_dimension_column_info2168"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_configured_feature_column_info1014
except ImportError:
    bt_configured_feature_column_info1014 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_configured_feature_column_info1014"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_configured_parameter_column_info2900
except ImportError:
    bt_configured_parameter_column_info2900 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_configured_parameter_column_info2900"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_configured_suppression_column_info2498
except ImportError:
    bt_configured_suppression_column_info2498 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_configured_suppression_column_info2498"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_configured_values_column_info1025_all_of
except ImportError:
    bt_configured_values_column_info1025_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_configured_values_column_info1025_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_column_info1222
except ImportError:
    bt_table_column_info1222 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_table_column_info1222"]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_column_spec1967
except ImportError:
    bt_table_column_spec1967 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_table_column_spec1967"]
