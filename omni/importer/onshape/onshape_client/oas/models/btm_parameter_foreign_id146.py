...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_foreign_data_response1070
except ImportError:
    bt_foreign_data_response1070 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_foreign_data_response1070"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_parameter_foreign_id146_all_of
except ImportError:
    btm_parameter_foreign_id146_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_parameter_foreign_id146_all_of"
    ]
