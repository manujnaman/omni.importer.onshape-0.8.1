...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_spec915
except ImportError:
    bt_table_spec915 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_table_spec915"]
