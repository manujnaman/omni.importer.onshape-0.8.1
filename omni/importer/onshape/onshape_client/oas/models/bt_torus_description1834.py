...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_torus_description1834_all_of
except ImportError:
    bt_torus_description1834_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_torus_description1834_all_of"
    ]
try:
