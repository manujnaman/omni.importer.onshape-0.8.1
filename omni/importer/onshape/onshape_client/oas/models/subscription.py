...
try:
    from omni.importer.onshape.onshape_client.oas.models import customer
except ImportError:
    customer = sys.modules["omni.importer.onshape.onshape_client.oas.models.customer"]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import plan
except ImportError:
    plan = sys.modules["omni.importer.onshape.onshape_client.oas.models.plan"]
try:
    from omni.importer.onshape.onshape_client.oas.models import subscription_item_collection
except ImportError:
    subscription_item_collection = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.subscription_item_collection"
    ]
