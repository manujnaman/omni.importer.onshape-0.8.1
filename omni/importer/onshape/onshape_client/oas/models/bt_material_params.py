...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_material_property_params
except ImportError:
    bt_material_property_params = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_material_property_params"
    ]
