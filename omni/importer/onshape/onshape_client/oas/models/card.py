...
try:
    from omni.importer.onshape.onshape_client.oas.models import three_d_secure
except ImportError:
    three_d_secure = sys.modules["omni.importer.onshape.onshape_client.oas.models.three_d_secure"]
