...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_type_name_standard291
except ImportError:
    btp_type_name_standard291 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btp_type_name_standard291"]
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_type_name_user292
except ImportError:
    btp_type_name_user292 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btp_type_name_user292"]
