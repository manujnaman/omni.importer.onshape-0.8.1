...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_bill_of_materials_table_row_metadata1300_all_of
except ImportError:
    bt_bill_of_materials_table_row_metadata1300_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_bill_of_materials_table_row_metadata1300_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_table_assembly_cross_highlight_data2675
except ImportError:
    bt_table_assembly_cross_highlight_data2675 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_table_assembly_cross_highlight_data2675"
    ]
try:
