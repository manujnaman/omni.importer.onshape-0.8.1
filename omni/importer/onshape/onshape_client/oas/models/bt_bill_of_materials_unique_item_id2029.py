...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_document_version_element_ids1897
except ImportError:
    bt_document_version_element_ids1897 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_document_version_element_ids1897"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_owner3114
except ImportError:
    bt_owner3114 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_owner3114"]
