...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_common_unit_info
except ImportError:
    bt_common_unit_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_common_unit_info"]
