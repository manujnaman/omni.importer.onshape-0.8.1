...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_parameter_reference_part_studio3302_all_of
except ImportError:
    btm_parameter_reference_part_studio3302_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_parameter_reference_part_studio3302_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_parameter_reference_with_configuration3028
except ImportError:
    btm_parameter_reference_with_configuration3028 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btm_parameter_reference_with_configuration3028"
    ]
