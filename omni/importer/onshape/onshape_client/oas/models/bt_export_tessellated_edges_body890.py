...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_export_tessellated_edges_body890_all_of
except ImportError:
    bt_export_tessellated_edges_body890_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_export_tessellated_edges_body890_all_of"
    ]
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_export_tessellated_edges_edge1364
except ImportError:
    bt_export_tessellated_edges_edge1364 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_export_tessellated_edges_edge1364"
    ]
