...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_feature_studio_contents2239_all_of
except ImportError:
    bt_feature_studio_contents2239_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_feature_studio_contents2239_all_of"
    ]
