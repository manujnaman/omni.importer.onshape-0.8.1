...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_id_translation_result_info
except ImportError:
    bt_id_translation_result_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_id_translation_result_info"
    ]
