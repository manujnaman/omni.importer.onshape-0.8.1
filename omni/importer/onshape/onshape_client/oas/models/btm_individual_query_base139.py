...
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_in_context_query2254
except ImportError:
    btm_in_context_query2254 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_in_context_query2254"]
try:
    from omni.importer.onshape.onshape_client.oas.models import btm_individual_query138
except ImportError:
    btm_individual_query138 = sys.modules["omni.importer.onshape.onshape_client.oas.models.btm_individual_query138"]
try:
