...
try:
    from omni.importer.onshape.onshape_client.oas.models import btfs_value_string1422_all_of
except ImportError:
    btfs_value_string1422_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btfs_value_string1422_all_of"
    ]
