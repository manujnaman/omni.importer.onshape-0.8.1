...
try:
    from omni.importer.onshape.onshape_client.oas.models import btpl_value_box_dereference251_all_of
except ImportError:
    btpl_value_box_dereference251_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btpl_value_box_dereference251_all_of"
    ]
