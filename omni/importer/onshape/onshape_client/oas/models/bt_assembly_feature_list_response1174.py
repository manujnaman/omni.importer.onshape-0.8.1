...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_assembly_feature_list_response1174_all_of
except ImportError:
    bt_assembly_feature_list_response1174_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_assembly_feature_list_response1174_all_of"
    ]
try:
