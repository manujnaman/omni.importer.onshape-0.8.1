...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_notice227
except ImportError:
    bt_notice227 = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_notice227"]
try:
