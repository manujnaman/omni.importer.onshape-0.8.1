...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_nullable_quantity_range1340
except ImportError:
    bt_nullable_quantity_range1340 = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_nullable_quantity_range1340"
    ]
try:
...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_parameter_spec_nullable_quantity715_all_of
except ImportError:
    bt_parameter_spec_nullable_quantity715_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_parameter_spec_nullable_quantity715_all_of"
    ]
try:
