...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_object_id
except ImportError:
    bt_object_id = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_object_id"]
try:
