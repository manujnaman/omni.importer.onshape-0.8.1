...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_address_info
except ImportError:
    bt_address_info = sys.modules["omni.importer.onshape.onshape_client.oas.models.bt_address_info"]
try:
