...
try:
    from omni.importer.onshape.onshape_client.oas.models import btp_type_name_user292_all_of
except ImportError:
    btp_type_name_user292_all_of = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.btp_type_name_user292_all_of"
    ]
