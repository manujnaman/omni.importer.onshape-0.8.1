...
try:
    from omni.importer.onshape.onshape_client.oas.models import bt_metadata_property_config_summary_info
except ImportError:
    bt_metadata_property_config_summary_info = sys.modules[
        "omni.importer.onshape.onshape_client.oas.models.bt_metadata_property_config_summary_info"
    ]
