...
try:
    from omni.importer.onshape.onshape_client.oas.models import o_auth_flow
except ImportError:
    o_auth_flow = sys.modules["omni.importer.onshape.onshape_client.oas.models.o_auth_flow"]
