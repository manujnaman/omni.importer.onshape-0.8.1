...
from omni.importer.onshape.onshape_client.oas import ApiClient
from omni.importer.onshape.onshape_client.oas import api
from omni.importer.onshape.onshape_client.oas.configuration import Configuration
...
class Client:
    ...
    conf_file : :obj:`str`, optional
        The path to the location of an omni.importer.onshape.onshape_client_config YAML file, where multiple stacks may be declared.
    ...
    add_defaults(
        ...
        client_id="omni.importer.onshape.onshape_client_ID",
        client_secret="omni.importer.onshape.onshape_client_SECRET",
    ...
    def __init__(
        self,
        keys_file="~/.omni.importer.onshape.onshape_client_config.yaml",
        configuration=None,
        stack_key=None,
    ...
    def refresh_access_token(self):
        ...
        try:
            ...
            raise UnauthorizedClientError("The token could not be refreshed.")
